...
모닥모닥은 "모으다"라는 의미를 담은 방언에서 영감을 받아 탄생한 프라이빗 모임 관리 및 추억 공유 플랫폼입니다. <br>
<span style="background-color: #ffdce0; color: black;">공개적인 SNS의 피로감에서 벗어나, 우리만의 소중한 공간에서 모임을 기록하고 추억을 나눌 수는 없을까?</span> 라는 질문에서 시작되었습니다. <br>
